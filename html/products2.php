	...
	<br>
	 ...
	 <div class="small-container">
			 ...
			 <div class="col-4">
				 ...
				 <h4>Grey Cotton 370 GSM Bath Towel</h4></a>
				 <p class="price"><b>&#8377;</b>599</p>
			 </div>
			 <div class="col-4">
			     <a href="pd8.php">
			     <img src="..\images\f8.jpg" alt="face towel">
				 <h4>Blue Microfiber 425 GSM Kid Towel</h4></a>
			 ...
			 <div class="col-4">
				 ...
				 <h4>Peach Cotton Casper Solid 550 GSM Large Bath Towel</h4></a>
				 <p class="price"><b>&#8377;</b>1,299</p>
			 </div>
			 <div class="col-4">
			     <a href="pd11.php">
			     <img src="..\images\f11.jpg" alt="ladies towel">
				 <h4>Coral Textured Stripe Cotton 550 GSM Bath Towel</h4></a>
				 <p class="price"><b>&#8377;</b>749</p>
			 </div>
			 <div class="col-4">
			     <a href="pd12.php">
			     <img src="..\images\f12.jpg" alt="face towel">
				 <h4>Mark Home 100% Cotton 500 GSM Zero Twist Anti Microbial Treated Simply Soft Hand Towel Maroon</h4></a>
	 ...
	 <div class="page-btn">
        <a href="products1.php"><span>&#8592;</span></a>
