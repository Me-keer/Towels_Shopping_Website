...
<body>
    ...
    <div class="card-wrapper">
        <div class="card">
            ...
            <div class="product-imgs">
                <div class="img-display">
                    <div class="img-showcase">
                        <img src="..\images2\f9.jpg">
                        <img src="..\images2\f9a.jpg">
                        <img src="..\images2\f9b.jpg">
                ...
                <div class="img-select">
                    <div class="img-item">
                        <a href="#" data-id="1">
                            <img src="../images2/f9.jpg" alt="towel image">
                        </a>
                    </div>
                    <div class="img-item">
                        <a href="#" data-id="2">
                            <img src="../images2/f9a.jpg" alt="towel image">
                        </a>
                    </div>
                    <div class="img-item">
                        <a href="#" data-id="3">
                            <img src="../images2/f9b.jpg" alt="towel image">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="product-content">
                <h2 class="product-title">Red Cotton 450 Bath Towel</h2>
                <div class="product-price">
                    <h4 class="price">M.R.P&nbsp;&nbsp;<b>&#8377;</b>&nbsp;799</h4>
                    </br>
                </div>
    ...
    <div class="small-container">
        <div class="row">
            ...
            <div class="col-4">
                <a href="pd12.php">
                    <img src="..\images\f12.jpg" alt="face towel"></a>
