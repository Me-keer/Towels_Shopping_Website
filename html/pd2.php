    ...
    <div class="card-wrapper">
        <div class="card">
            ...
            <div class="product-imgs">
                <div class="img-display">
                    <div class="img-showcase">
                        <img src="..\images2\f2.jpg">
                        <img src="..\images2\f2a.jpg">
                        <img src="..\images2\f2b.jpg">
                    </div>
                </div>
                <div class="img-select">
                    <div class="img-item">
                        <a href="#" data-id="1">
                            <img src="../images2/f2.jpg" alt="towel image">
                        </a>
                    </div>
                    <div class="img-item">
                        <a href="#" data-id="2">
                            <img src="../images2/f2a.jpg" alt="towel image">
                        </a>
                    </div>
                    <div class="img-item">
                        <a href="#" data-id="3">
                            <img src="../images2/f2b.jpg" alt="towel image">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="product-content">
                <h2 class="product-title">Frozen Pink Microfiber Bath Towel</h2>
                <div class="product-price">
                    <h4 class="price">M.R.P&nbsp;&nbsp;<b>&#8377;</b>&nbsp;199</h4>
                    </br>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-4">
                <a href="pd3.php">
                    ...
                    <h4>Red Cotton 280 GSM Ladies Bath Towel</h4>
                </a>
