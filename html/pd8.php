    ...
    <div class="card-wrapper">
        <div class="card">
            ...
            <div class="product-imgs">
                <div class="img-display">
                    <div class="img-showcase">
                        <img src="..\images2\f8.jpg">
                        <img src="..\images2\f8a.jpg">
                        <img src="..\images2\f8b.jpg">
                ...
                <div class="img-select">
                    <div class="img-item">
                        <a href="#" data-id="1">
                            <img src="../images2/f8.jpg" alt="towel image">
                        </a>
                    </div>
                    <div class="img-item">
                        <a href="#" data-id="2">
                            <img src="../images2/f8a.jpg" alt="towel image">
                        </a>
                    </div>
                    <div class="img-item">
                        <a href="#" data-id="3">
                            <img src="../images2/f8b.jpg" alt="towel image">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="product-content">
                <h2 class="product-title">Apple Green Microfiber 425 GSM Kid Towel</h2>
                <div class="product-price">
                    <h4 class="price">M.R.P&nbsp;&nbsp;<b>&#8377;</b>&nbsp;499</h4>
                    </br>
                </div>

                <div class="product-detail">
                    <ul>
                        <li>Color: <span>Apple Green</span></li>
                        <li>Available: <span>in stock</span></li>
                        <li>Set Content: <span>1 Bath Towel</span></li>
                        <li>Category: <span>Kids Towel</span></li>
        ...
        <div class="row">
            ...
            <div class="col-4">
                <a href="pd6.php">
                    ...
                    <h4>Black Cotton 390 GSM Bath Towel</h4>
                </a>
                <p class="price"><b>&#8377;</b>829</p>
            </div>
            <div class="col-4">
                <a href="pd7.php">
                    <img src="..\images\f7.jpg" alt="ladies towel">
                    <h4>Grey Cotton 370 GSM Bath Towel</h4>
                </a>
                <p class="price"><b>&#8377;</b>599</p>
            </div>
            <div class="col-4">
                <a href="pd8.php">
                    <img src="..\images2\f8.jpg" alt="face towel">
                    <h4>Apple Green Microfiber 425 GSM Kid Towel</h4>
                </a>
                <p class="price"><b>&#8377;</b>499</p>
            </div>
        </div>
