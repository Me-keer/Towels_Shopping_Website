    ...
    <div class="card-wrapper">
        <div class="card">
            ...
            <div class="product-imgs">
                <div class="img-display">
                    <div class="img-showcase">
                        <img src="..\images2\f4.jpg">
                        <img src="..\images2\f4a.jpg">
                        <img src="..\images2\f4b.jpg">
                ...
                <div class="img-select">
                    <div class="img-item">
                        <a href="#" data-id="1">
                            <img src="../images2/f4.jpg" alt="shoe image">
                        </a>
                    </div>
                    <div class="img-item">
                        <a href="#" data-id="2">
                            <img src="../images2/f4a.jpg" alt="shoe image">
                        </a>
                    </div>
                    <div class="img-item">
                        <a href="#" data-id="3">
                            <img src="../images2/f4b.jpg" alt="shoe image">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="product-content">
                <h2 class="product-title">Set of 5 Blue Cotton 500 GSM Face Towels</h2>
                <div class="product-price">
                    <h4 class="price">M.R.P&nbsp;&nbsp;<b>&#8377;</b>&nbsp;349</h4>
                    </br>
                </div>
                ...
                <div class="product-detail">
                    <ul>
                        ...
                        <li>Category: <span>Face Towel</span></li>
                        <li>Set Content:<span>Set of 5 Face towel</span></li>
