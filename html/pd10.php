    ...
    <div class="card-wrapper">
        <div class="card">
            ...
            <div class="product-imgs">
                <div class="img-display">
                    <div class="img-showcase">
                        <img src="..\images2\f10.jpg">
                        <img src="..\images2\f10a.jpg">
                        <img src="..\images2\f10b.jpg">
                ...
                <div class="img-select">
                    <div class="img-item">
                        <a href="#" data-id="1">
                            <img src="../images2/f10.jpg" alt="towel image">
                        </a>
                    </div>
                    <div class="img-item">
                        <a href="#" data-id="2">
                            <img src="../images2/f10a.jpg" alt="towel image">
                        </a>
                    </div>
                    <div class="img-item">
                        <a href="#" data-id="3">
                            <img src="../images2/f10b.jpg" alt="towel image">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="product-content">
                <h2 class="product-title">Peach Cotton Casper Solid 550 GSM Large Bath Towel</h2>
                <div class="product-price">
                    <h4 class="price">M.R.P&nbsp;&nbsp;<b>&#8377;</b>&nbsp;1,299</h4>
                    </br>
                </div>

                <div class="product-detail">
                    <ul>
                        <li>Color: <span>Peach</span></li>
                        <li>Category: <span>Large Bath Towel</span></li>
