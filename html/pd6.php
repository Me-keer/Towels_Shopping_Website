...
<body>
    ...
    <div class="card-wrapper">
        <div class="card">
            ...
            <div class="product-imgs">
                <div class="img-display">
                    <div class="img-showcase">
                        <img src="..\images2\f6.jpg">
                        <img src="..\images2\f6a.jpg">
                        <img src="..\images2\f6b.jpg">
                ...
                <div class="img-select">
                    <div class="img-item">
                        <a href="#" data-id="1">
                            <img src="../images2/f6.jpg" alt="towel image">
                        </a>
                    </div>
                    <div class="img-item">
                        <a href="#" data-id="2">
                            <img src="../images2/f6a.jpg" alt="towel image">
                        </a>
                    </div>
                    <div class="img-item">
                        <a href="#" data-id="3">
                            <img src="../images2/f6b.jpg" alt="towel image">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="product-content">
                <h2 class="product-title">Black Cotton 390 GSM Bath Towel</h2>
                <div class="product-price">
                    <h4 class="price">M.R.P&nbsp;&nbsp;<b>&#8377;</b>&nbsp;829</h4>
                    </br>
                </div>
                ...
                <div class="product-detail">
                    <ul>
                        ...
                        <li>Category: <span>Bath Towel</span></li>
    ...
    <div class="small-container">
        <div class="row">
            ...
            <div class="col-4">
                <a href="pd8.php">
                    <img src="..\images\f8.jpg" alt="face towel">
                    <h4>Blue Microfiber 425 GSM Kid Towel</h4>
                </a>
