    ...
    <div class="card-wrapper">
        <div class="card">
            ...
            <div class="product-imgs">
                <div class="img-display">
                    <div class="img-showcase">
                        <img src="..\images2\f3.jpg">
                        <img src="..\images2\f3a.jpg">
                        <img src="..\images2\f3b.jpg">
                ...
                <div class="img-select">
                    <div class="img-item">
                        <a href="#" data-id="1">
                            <img src="../images2/f3.jpg" alt="shoe image">
                        </a>
                    </div>
                    <div class="img-item">
                        <a href="#" data-id="2">
                            <img src="../images2/f3a.jpg" alt="shoe image">
                        </a>
                    </div>
                    <div class="img-item">
                        <a href="#" data-id="3">
                            <img src="../images2/f3b.jpg" alt="shoe image">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="product-content">
                <h2 class="product-title">Pink Cotton 280 GSM Ladies Bath Towel</h2>
                <div class="product-price">
                    <h4 class="price">M.R.P&nbsp;&nbsp;<b>&#8377;</b>&nbsp;229</h4>
                    </br>
                </div>

                <div class="product-detail">
                    <ul>
                        <li>Color: <span>Pink</span></li>
                        <li>Category: <span>Ladies Bath Towel</span></li>
                        <li>Set Content:<span>1 Ladies Towels</span></li>
        ...
        <div class="row">
            <div class="col-4">
                <a href="pd1.php">
                    ...
                    <h4>White 100% Cotton 8 Pieces 550 GSM Towel Set</h4>
                </a>
            ...
            <div class="col-4">
                <a href="pd2.php">
                    ...
                    <h4>Frozen Pink Microfiber Bath Towel</h4>
                </a>
            ...
            <div class="col-4">
                <a href="pd3.php">
                    ...
                    <h4>Pink Cotton 280 GSM Ladies Bath Towel</h4>
                </a>
            ...
            <div class="col-4">
                <a href="pd4.php">
                    ...
                    <h4>Set of 5 Blue Cotton 500 GSM Face Towels</h4>
                </a>
